...
INSERT INTO `ify`.`azienda` (`partita_iva`, `descrizione`, `ragione_sociale`, `sede`, `settore`) VALUES ('1234567812', 'azienda per il testing', 'azienda testing', 'Salerno', 'Informatica');
...
INSERT INTO `ify`.`delegato_aziendale` (`ruolo`, `id`, `azienda_partita_iva`) VALUES ('Direttore', '3', '1234567812');
INSERT INTO `ify`.`richiesta_convenzionamento` (`id`, `stato`, `azienda_partita_iva`, `delegato_aziendale_id`) VALUES ('2', 'accettata', '1234567812', '3');
INSERT INTO `ify`.`progetto_formativo` (`id`, `ambito`, `attivita`, `conoscenze`, `data_compilazione`, `descrizione`, `max_partecipanti`, `nome`, `stato`, `azienda_partita_iva`) VALUES ('1', 'Informatica', 'Progetto', 'C e Java', '2020-01-11', 'progetto testing', '2', 'Prog Testing', 'attivo', '1234567812');
...
INSERT INTO `ify`.`domanda_tirocinio` (`id`, `cfu`, `conoscenze`, `data_fine`, `data_inizio`, `motivazioni`, `stato`, `azienda_partita_iva`, `docente_tutor_id`, `progetto_formativo_id`, `studente_id`) 
