							...
							<li><a href="#homeSubmenuDomande" data-toggle="collapse"
								...
								<ul class="collapse list-unstyled" id="homeSubmenuDomande">
									<li><a href="./visualizzaDomandeTirocinioInAttesaDocente">Domande
										in attesa</a></li>
									<li><a href="./visualizzaDomandeTirocinioInoltrateDocente" class="active">Domande
										inoltrate</a></li>

								</ul></li>

							<li><a href="./visualizzaTirociniInCorsoDocente">Tirocini
								in corso</a></li>
						</ul>
					</div>
				</nav>
							...
							<tbody>
								...
								<c:forEach items="${domandeTirocinio}" var="current" varStatus="loop">
									<tr>
										...
										<c:choose>
											<c:when test="${current.stato == 'accettata_tutor'}">
												<td class="testo-tabella">In attesa dell'azienda</td>
											</c:when>
											<c:otherwise>
